    ...
    <?php 
        ...
        if (!empty($complaints)): 
            foreach ($complaints as $complaintsItem):  
                if ($complaintsItem['routing_officer']== 1 && $complaintsItem['dept_comp_officer'] == 1 && $complaintsItem['approved'] == 1 && $complaintsItem['closed'] == 1 && $complaintsItem['dept_id']== $compOfficerDeptId):  
                    $found = true; 
    ?>   
            <div class="adminRec">
