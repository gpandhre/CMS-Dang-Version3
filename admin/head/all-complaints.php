...
<div class="admins">
    ...
    <?php 
        ...
        if(isset($_SESSION['auth_head']))
        {
            ...
            $complaints = [];
            $deptHeadId = $_SESSION['auth_head']['dept_id'];
        ...
        if (!empty($complaints)): 
            foreach ($complaints as $complaintsItem):  
                if ($complaintsItem['dept_comp_officer']== 1 && $complaintsItem['dept_id']== $deptHeadId):  
                    $found = true; 
    ?>   
            <div class="adminRec">
                ...
                <?php
                    if($complaintsItem['dept_comp_officer']=='1' && $complaintsItem['dept_head'] == '1' && $complaintsItem['approved'] == '0')
                    {
                        ?>
                        <div>Pending</div>
                        <?php
                    }
                    elseif($complaintsItem['dept_comp_officer']=='1' && $complaintsItem['dept_head'] == '1' && $complaintsItem['approved'] == '1')
                    {
                        ?>
                        <div>Approved</div>
                        <?php
                    }
                    elseif($complaintsItem['dept_comp_officer']=='1' && $complaintsItem['dept_head'] == '1' && $complaintsItem['approved'] == '1' && $complaintsItem['closed'] == '0')
                    {
                        ?>
                        <div>In-progress</div>
                        <?php
